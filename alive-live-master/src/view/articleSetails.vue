...
<template>
  <div class="articleSetails">
    ...
    <div class="aduio-banner" v-if="state.details == '8'">
      ...
      <div class="aduio-content">
        <div class="content-content">
          ...
          <div class="content2">
            <img v-if="!state.showHied" @click="clickShow" src="../assets/one/play/feeds_radio_play.png" />
            <img v-if="state.showHied" @click="clickHied" src="../assets/one/play/feeds_radio_pause.png" />
          </div>
          <div class="content1">
    ...
    <div class="bottom">
      ...
      <div class="bottom-top2" @click="playMusic" v-if="state.details == '1'">有声读物| {{ state.content.anchor }} 总时长 {{
        state.duration
      }}</div>
